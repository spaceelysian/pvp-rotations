...
public class MCHPvP : MachinistRotation
{
    ...
    protected override bool GeneralGCD(out IAction? act)
    {
        ...
        if (Player.HasStatus(true, StatusID.Analysis))
        {
            ...
            if (Player.HasStatus(true, StatusID.DrillPrimed) && !Player.HasStatus(true, StatusID.BioblasterPrimed, StatusID.ChainSawPrimed, StatusID.AirAnchorPrimed, StatusID.Overheated_3149) && DrillPvP.CanUse(out act, skipAoeCheck: true)) return true;
        }
